...
SET "exe=java"
SET "fixed_params= -jar C:\Users\roble\Proyectos\CMinSA\target\java-1.0-SNAPSHOT-jar-with-dependencies.jar"
...
%exe% %fixed_params% %instance% %candidate_parameters% 1>%stdout% 2>%stderr%
